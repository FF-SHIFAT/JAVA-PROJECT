...
public class CustomerSignIn implements ActionListener,ICustomerSignIn{
    ...
    frame = new JFrame("AmaderDokan");
    frame.setSize(800, 550);

    // Set the background color for the frame
    frame.getContentPane().setBackground(Color.decode("#44CEF6"));
        ...
        title.setForeground(Color.decode("#008000"));
...
//        frame.add(loginAlert);
        ...
        loginButton.setBackground(Color.decode("#C7EA46"));
        ...
        signUpButton1.setBackground(Color.decode("#96E5E2"));
        ...
        signUpButton1.setForeground(new Color(241,39,97));
...
//        frame.add(frgtpass);
        ...
        exitButton.setBackground(Color.decode("#43B7BA"));
